...
:USETHEOLDEST
SET Benchmark=CIS_Microsoft_Windows_10_Enterprise_Release_1903_Benchmark_v1.7.1-xccdf.xml
...
IF %SSLF%==1 GOTO NINETEENOHTHREESSLF
...
SET Benchmark=CIS_Microsoft_Windows_10_Enterprise_Release_1909_Benchmark_v1.8.1-xccdf.xml
...
IF %SSLF%==1 GOTO NINETEENOHNINESSLF
...
:UNKNOWNWINDOWS10
ECHO.
ECHO Discovered Windows 10 2004 (or higher)
SET Benchmark=CIS_Microsoft_Windows_10_Enterprise_Release_2004_Benchmark_v1.9.1-xccdf.xml
...
IF %SSLF%==1 GOTO TWOTHOUSANDFOURSSLF
...
SET Benchmark=CIS_Microsoft_Windows_Server_2012_R2_Benchmark_v2.4.0-xccdf.xml
...
SET Benchmark=CIS_Microsoft_Windows_Server_2012_(non-R2)_Benchmark_v2.2.0-xccdf.xml
...
SET Benchmark=CIS_Microsoft_Windows_Server_2016_RTM_(Release_1607)_Benchmark_v1.2.0-xccdf.xml
...
SET Benchmark=CIS_Microsoft_Windows_Server_2019_Benchmark_v1.1.0-xccdf.xml
